...
function change(){
    ...
    document.querySelector(".material-icons.slider_arrow_left").style.visibility = data.scenes[data.sceneNum].arrow_left;
    document.querySelector(".material-icons.slider_arrow_right").style.visibility = data.scenes[data.sceneNum].arrow_right;
}
...
var console = data.sceneNum;

function slider_next(){
    console.log("works"+data.sceneNum);
    if(data.sceneNum === data.sceneNum){
        data.sceneNum++;
        console.log(data.sceneNum);
        change();
    }
}
