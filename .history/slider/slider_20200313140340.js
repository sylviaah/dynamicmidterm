...
function progressReset(){
    document.querySelector(data.scenes2.progress).style.backgroundColor = "white";
    document.querySelector(data.scenes3.progress).style.backgroundColor = "white";
    document.querySelector(data.scenes4.progress).style.backgroundColor = "white";
    document.querySelector(data.scenes5.progress).style.backgroundColor = "white";
}
