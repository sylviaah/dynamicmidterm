...
function progressReset(){
    document.querySelector(data.scenes[2].progress).style.backgroundColor = "white";
    document.querySelector(data.scenes[3].progress).style.backgroundColor = "white";
    document.querySelector(data.scenes[4].progress).style.backgroundColor = "white";
    document.querySelector(data.scenes[5].progress).style.backgroundColor = "white";
}
