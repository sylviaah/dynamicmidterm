...
function change(){
    document.querySelector(".slider_image.img1").src = data.scene+(storyNum)[data.sceneNum].image1;
    document.querySelector(".slider_image.img2").src = data.scene+storyNum[data.sceneNum].image1;
    document.querySelector(".material-icons.arrow_left").style.visibility = data.scene+storyNum[data.sceneNum].arrow_left;
    document.querySelector(".material-icons.arrow_right").style.visibility = data.scene+storyNum[data.sceneNum].arrow_right;
}
